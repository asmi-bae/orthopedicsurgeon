...
CREATE INDEX idx_lab_reports_doctor_date ON lab_reports (doctor_id, reported_at);
...
-- User audits
CREATE INDEX idx_audit_logs_entity_composite ON audit_logs (entity_type, entity_id, created_at DESC);
