package com.orthopedic.api.modules.hospital.controller.admin;
...
public class AdminHospitalController extends BaseController {
    ...
    @GetMapping
    @Operation(summary = "Get all hospitals for admin with filtering and pagination")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get hospital by ID for admin")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Soft delete / Deactivate a hospital")
    ...
    @Operation(summary = "Get all services of a hospital for admin")
