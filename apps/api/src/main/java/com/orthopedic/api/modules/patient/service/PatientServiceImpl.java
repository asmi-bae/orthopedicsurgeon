...
public class PatientServiceImpl implements PatientService {
    ...
    @Override
    @Transactional(readOnly = true)
    @PreAuthorize("hasAnyRole('DOCTOR_ADMIN', 'STAFF', 'DOCTOR', 'SUPER_ADMIN') or @permissionEvaluator.isPatientOwner(authentication, #id)")
    ...
    @Override
    @Transactional(readOnly = true)
    @PreAuthorize("hasAnyRole('DOCTOR_ADMIN', 'DOCTOR', 'SUPER_ADMIN') or @permissionEvaluator.isPatientOwner(authentication, #id)")
