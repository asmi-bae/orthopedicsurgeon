...
import com.orthopedic.api.modules.auth.repository.UserRepository;
...
public class BlogServiceImpl {
    ...
    public BlogPostResponse getPostBySlug(String slug) {
        ...
        return BlogPostResponse.builder()
                ...
                .tags(post.getTags().stream().map(t -> new BlogTagResponse(t.getId(), t.getName(), t.getSlug()))
                        .toList())
    ...
    public BlogPostResponse createPost(CreateBlogPostRequest req, Long authorId) {
        ...
        BlogPost post = BlogPost.builder()
                ...
                .category(req.categoryId() != null ? blogCategoryRepository.getReferenceById(req.categoryId()) : null)
    ...
    private String generateUniqueSlug(String title) {
        ...
        String slug = base;
        int counter = 1;
        while (blogPostRepository.findBySlugAndStatus(slug, null).isPresent()) { // Will match any since status is not
                                                                                 // checked here correctly without
