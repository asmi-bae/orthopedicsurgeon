...
public class PatientResponse {
    ...
    public String getMedicalHistoryNotes() { return medicalHistoryNotes; }
    public void setMedicalHistoryNotes(String medicalHistoryNotes) { this.medicalHistoryNotes = medicalHistoryNotes; }

    public Patient.PatientStatus getStatus() { return status; }
    ...
    public static class AllergyResponse {
        ...
        public PatientAllergy.Severity getSeverity() { return severity; }
        public void setSeverity(PatientAllergy.Severity severity) { this.severity = severity; }
    }
