      ...
      <section class="relative h-[60vh] bg-secondary-900 overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 w-full pb-20">
          <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <mat-chip class="premium-badge mb-8">{{ 'BLOG.POSTS.HIP_REPLACEMENT.CATEGORY' | translate }}</mat-chip>
            <h1 class="text-6xl font-black text-white tracking-tighter uppercase leading-none mb-10">
              {{ 'BLOG.POSTS.HIP_REPLACEMENT.TITLE_PART1' | translate }} <br/>
              <span class="text-primary tracking-normal">{{ 'BLOG.POSTS.HIP_REPLACEMENT.TITLE_PART2' | translate }}</span>
            </h1>
            ...
            <div class="flex items-center gap-8 text-white">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-[8px] font-bold text-primary uppercase tracking-[0.2em]">{{ 'CAREERS.VACANCIES.SURGEON.DEPT' | translate }}</p>
                </div>
              </div>
              <div class="h-8 w-[1px] bg-white/10"></div>
              <div class="text-white/40">
                <p class="text-[10px] font-black uppercase tracking-widest">{{ 'BLOG.DETAIL.RELEASED' | translate }}</p>
                <p class="text-[10px] font-bold uppercase tracking-tight">{{ 'HOME.BLOG.NEWS1.DATE' | translate }}</p>
              </div>
              <div class="h-8 w-[1px] bg-white/10"></div>
              <div class="text-white/40">
                <p class="text-[10px] font-black uppercase tracking-widest">{{ 'BLOG.DETAIL.PROTOCOL' | translate }}</p>
                <p class="text-[10px] font-bold uppercase tracking-tight">8 {{ 'BLOG.DETAIL.READ_TIME' | translate }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="prose prose-xl prose-secondary max-w-none">
            <p class="text-2xl font-bold text-secondary-900 leading-relaxed mb-12 border-l-4 border-primary pl-10">
              {{ 'BLOG.DETAIL.INTRO' | translate }}
            </p>

            <h3 class="text-3xl font-black text-secondary-900 uppercase tracking-tight mt-16 mb-8">{{ 'BLOG.DETAIL.PRECISION_TITLE' | translate }}</h3>
            <p class="text-secondary-600 leading-relaxed mb-8">
              {{ 'BLOG.DETAIL.PRECISION_TEXT' | translate }}
            </p>
            ...
            <h3 class="text-3xl font-black text-secondary-900 uppercase tracking-tight mt-16 mb-8">{{ 'BLOG.DETAIL.RESTORATION_TITLE' | translate }}</h3>
            <p class="text-secondary-600 leading-relaxed mb-8">
              {{ 'BLOG.DETAIL.RESTORATION_TEXT' | translate }}
            </p>
            ...
            <div class="bg-gray-50 rounded-[40px] p-12 my-16 border border-gray-100 flex items-start gap-8">
              ...
              <div>
                <h4 class="text-xl font-black text-secondary-900 uppercase tracking-tight mb-4">{{ 'BLOG.DETAIL.HIGHLIGHT.TITLE' | translate }}</h4>
                <p class="text-secondary-600 text-sm leading-relaxed font-medium">{{ 'BLOG.DETAIL.HIGHLIGHT.TEXT' | translate }}</p>
              </div>
            </div>

            <p class="text-secondary-600 leading-relaxed mb-8">
              {{ 'BLOG.DETAIL.COMMITMENT' | translate }}
            </p>
          </div>
