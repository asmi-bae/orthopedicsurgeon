        ...
        <zrd-card variant="default" class="p-0 overflow-hidden !rounded-[28px] bg-white dark:bg-google-gray-50 ring-1 ring-black/5">
          ...
          <div class="p-2 border-t border-google-gray-100 dark:border-white/10">
             <div class="grid grid-cols-1 gap-1">
               <a routerLink="/account" [queryParams]="{ tab: 0 }" (click)="close()" class="flex items-center gap-4 p-4 px-6 rounded-full hover:bg-google-gray-50 dark:hover:bg-white/5 transition-colors group">
               ...
               <a routerLink="/account" [queryParams]="{ tab: 1 }" (click)="close()" class="flex items-center gap-4 p-4 px-6 rounded-full hover:bg-google-gray-50 dark:hover:bg-white/5 transition-colors group">
