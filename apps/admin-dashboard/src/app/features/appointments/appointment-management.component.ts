...
import { ZrdTableComponent, ZrdBadgeComponent, ZrdPageHeaderComponent } from '@repo/ui';

@Component({
  selector: 'app-appointment-management',
  standalone: true,
  imports: [CommonModule, ZrdTableComponent, ZrdBadgeComponent, ZrdPageHeaderComponent],
  template: `
