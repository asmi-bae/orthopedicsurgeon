...
import { ZrdCardComponent, ZrdButtonComponent, ZrdBadgeComponent, ZrdSearchInputComponent, ZrdAvatarComponent } from '@repo/ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, ZrdCardComponent, ZrdButtonComponent, ZrdBadgeComponent, ZrdSearchInputComponent, ZrdAvatarComponent],
  template: `
